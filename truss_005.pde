...
void draw() { 
    ...
    if (mouseX > point04[0]-rectSize && mouseX < point04[0]+rectSize && mouseY > point04[1]-rectSize && mouseY < point04[1]+rectSize) {
        overPoint04 = true;  
        if(!lockedPoint04) { 
            strokePoint01 = false;
            strokePoint02 = false;
    ...
    if (mouseX > point05[0]-rectSize && mouseX < point05[0]+rectSize && mouseY > point05[1]-rectSize && mouseY < point05[1]+rectSize) {
        overPoint05 = true;  
        if(!lockedPoint05) { 
            strokePoint01 = false;
            strokePoint02 = false;
    ...
    if (mouseX > point06[0]-rectSize && mouseX < point06[0]+rectSize && mouseY > point06[1]-rectSize && mouseY < point06[1]+rectSize) {
        overPoint06 = true;  
        if(!lockedPoint06) { 
            strokePoint01 = false;
            strokePoint02 = false;
